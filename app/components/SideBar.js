...
function SideBar({ tocHtml }) {
    ...
    if (menu) {
        return <aside ref={ref} className='z-50 h-full overscroll-contain overflow-y-auto flex flex-col fixed top-0 left-0 bottom-0 w-full md:max-w-[30%] md:w-min-[600px] bg-slate-900 p-4'>
